...
class wrapperBama
{
    ...
    public function html($asString = FALSE)
    {
        ...
        $admin_login_link = (isset($_COOKIE['aes_admin'])) ? $admin_login_link = '<a class="nav-item nav-link superadmin" href="/users/admin_login.php">Admin Log In</a>' : '';
        $loginas_logout_link = (isset($_SESSION['originalUserId'])) ? '<div class="nav-item"><a class="nav-item nav-link superadmin" href="/admin/restoreAdmin.php">Restore Admin</a></div>' : '';
